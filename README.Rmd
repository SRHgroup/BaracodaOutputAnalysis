...
### seqloggo_generator: Making ggseq logos 
```{r}
seqloggo_generator(data = my_clean_augment_data ,
                   len = 9,
                   resp = c("yes"))
```
